...
mongoClient.open(function(err, mongoClient) {
  ...
  var dir = "/Volumes/groups/maenad/activities/austese/Nostromo Images/Nostromo TS2/";
      ...
      if (image[0] != "."){
          ...
          function writeToGridFSPut (err,data){
              ...
              grid.put(fileData, {_id: fileId, 
                  ...
                  metadata:{_resourceid: resId, title: imageTitle, filetype:'image/jpg', project:'24', generated: 'NImport'}}, function(err, result) {
                      if (err){
                          console.log(err);
                      }
                      console.log(image);
...
// db.fs.files.drop()
// db.fs.chunks.drop()
// run the import script ie node NostromoImageImport.js 
/*
